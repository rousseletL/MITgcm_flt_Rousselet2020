...
**Pre-processing:**
- `create_input_offline_backward_clim.m`: create input binary file for MITgcm_flt with data from ECCOv4. Data are reversed in sign and time to perform backward integration.
...
**Post-processing:**
- `flt_outputs.m`: collate float_trajectories* in flts (matlab structure).
